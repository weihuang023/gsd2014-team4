...
public class MainActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(recipeList.size()!=0) {
			...
			ListAdapter adapter = new SimpleAdapter( MainActivity.this,recipeList, R.layout.recipe_entry, new String[] { "recipeId","recipeName", "recipeTime"}, new int[] {R.id.recipeId, R.id.recipeName, R.id.recipeTime});
