...
public class ViewRecipe extends Activity{
	...
	public void quesRecipe(View view){
		
		Intent theIntent = getIntent();
				
		this.callQuesActivity(view);
		
	}
	public void favoRecipe(View view){
		...
		this.callFavoActivity(view);
		
	}
	public void commRecipe(View view){
		...
		this.callCommActivity(view);
		
	}
	public void callQuesActivity(View view){
		
		Intent objIntent = new Intent(getApplication(), MainActivity.class);
		
		startActivity(objIntent);
	}
	public void callFavoActivity(View view){
	...
	public void callCommActivity(View view){
