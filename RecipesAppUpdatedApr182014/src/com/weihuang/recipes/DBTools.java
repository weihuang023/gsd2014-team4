...
public class DBTools extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase database) {
		...
		String query = "CREATE TABLE recipes ( recipeId INTEGER PRIMARY KEY, recipeName TEXT, " +
		"recipeDescription TEXT, recipeTime TEXT, recipeIngredients TEXT, recipeInstruction TEXT)";
	...
	public void insertRecipe(HashMap<String, String> queryValues){
		...
		values.put("recipeDescription", queryValues.get("recipeDescription"));
		values.put("recipeTime", queryValues.get("recipeTime"));
	...
	public ArrayList<HashMap<String, String>> getAllRecipes(){
		...
		if(cursor.moveToFirst()){
			...
			do{
				...
				recipeMap.put("recipeDescription", cursor.getString(2));
				recipeMap.put("recipeTime", cursor.getString(3));
				recipeMap.put("recipeIngredients", cursor.getString(4));
				recipeMap.put("recipeInstruction", cursor.getString(5));
